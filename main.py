...
Label(root, text="TEXT TO SPEECH", font="arial 20 bold", bg="white", fg="black").place(x=100, y=30)
...
imageicon2=PhotoImage(file="downloadd.png")
save_btn = Button(root, text="Save", compound=LEFT, image=imageicon2, width=130, bg="#39c790", font="arial 14 bold", command=download)
